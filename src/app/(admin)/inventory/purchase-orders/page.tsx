    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm">Total Purchase Orders</p>
        </div>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm w-64"
                />
              </div>
            </div>
          </div>
        ...
        <div className="p-6">
          <div className="text-center py-12">
            ...
            <h4 className="text-lg font-medium text-gray-900 dark:text-white mb-2">No Purchase Orders</h4>
            <p className="text-gray-500 dark:text-gray-400 mb-4">
              Create your first purchase order to start ordering inventory from suppliers.
            </p>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700">
        ...
        <div className="p-6">
          <div className="text-center py-8">
            <p className="text-gray-500 dark:text-gray-400">No recent purchase order activity.</p>
          </div>
        </div>
      </div>
    </div>
